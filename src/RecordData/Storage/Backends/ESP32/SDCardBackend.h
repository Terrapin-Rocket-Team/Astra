#ifndef ESP32_SDCARD_BACKEND_H
#define ESP32_SDCARD_BACKEND_H
 ...
 *
 * Uses ESP-IDF's SDMMC host driver with VFS FAT filesystem layer.
 * Supports both 1-bit and 4-bit SDMMC modes.
 *
