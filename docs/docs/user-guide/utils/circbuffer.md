...
For examples of `CircBuffer` in real sensors, see the barometer implementation on GitHub:
`https://github.com/Terrapin-Rocket-Team/Astra/blob/main/src/Sensors/Baro/Barometer.cpp`
