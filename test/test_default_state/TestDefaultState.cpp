...
void test_get_acceleration() {
    ...
    TEST_ASSERT_EQUAL(3, accel.size());
}
...
void test_asynchronous_sensor_updates() {
    ...
    TEST_ASSERT_NOT_EQUAL(pos1.x(), pos2.x());
